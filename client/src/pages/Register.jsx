...
function Register() {
  ...
  const handleValidation = () => {
    ...
    //   toast.error("Password should be atleast of", toastOptions)
    //   return false
    // }
    else if (email === " "){
    ...
    <div>
      <FormContainer>
        <form onSubmit={(event) => handleSubmit(event)}>
          ...
          <input type="text" name="password" id="passwword" placeholder='Passwword' onChange={e => handleChange(e)} />
          <input type="text" name="confirmpassword" id="confirmpassword" placeholder='Confirm Password' onChange={e => handleChange(e)} />
